from src.modules.subscribe_event.app.subscribe_event_viewmodel import SubscribeEventViewmodel
from src.shared.domain.entities.event import Event
 

class Test_SubscribeEventViewmodel:
    def test_subcribe_event_viewmodel(self):
        event = Event(
