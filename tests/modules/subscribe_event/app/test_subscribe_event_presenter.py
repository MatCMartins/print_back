...
from src.modules.subscribe_event.app.subscribe_event_presenter import lambda_handler
from src.shared.infra.repositories.event_repository_mock import EventRepositoryMock

class Test_SubscribeEventPresenter:
    @patch("src.modules.subscribe_event.app.subscribe_event_presenter.authenticate")
    def test_subscribe_event_presenter(self, mock_authenticate):
