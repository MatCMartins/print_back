...
from src.modules.get_notification.app.get_notification_presenter import lambda_handler
from src.shared.infra.repositories.notification_repository_mock import NotificationRepositoryMock

class Test_GetNotificationPresenter:
    @patch("src.modules.get_notification.app.get_notification_presenter.authenticate")
    def test_get_notification_presenter(self, mock_authenticate):
