...
class CourseRepositoryDynamo(ICourseRepository):
    @staticmethod
    def partition_key_format(course_id: str) -> str:
    ...
    def __init__(self):
        # Atualiza para usar a tabela específica do DynamoDB para "Course"
    ...
    def create_course(self, new_course: Course) -> Course:
        ...
        self.dynamo.put_item(
            partition_key=self.partition_key_format(new_course.course_id),
            sort_key=self.sort_key_format(new_course.course_id),
            item=course_dto.to_dynamo()
        )
        return new_course
    ...
    def update_course(
        ...
        new_course_photo: Optional[str] = None,
        new_coordinator: Optional[str] = None,
        new_coordinator_photo: Optional[str] = None,
