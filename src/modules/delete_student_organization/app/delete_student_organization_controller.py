...
from .delete_student_organization_viewmodel import DeleteStudentOrganizationViewmodel
...
class DeleteStudentOrganizationController:

    def __init__(self, usecase: DeleteStudentOrganizationsUsecase):
